...
def main():
    parser = argparse.ArgumentParser(description='Generate developer portal content for an API Management instance.')
    parser.add_argument('--folder', type=str, help='The folder containing the captured data.', required=True)
